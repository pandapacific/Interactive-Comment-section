...
// send comments functionality
// const commentForm = document.querySelectorAll(".commentForm"); //locate all available document forms
// // console.log(commentForm);

// commentForm.forEach(form => {
//     // define the screen test function
...
//     const user = {
//         name: "juliusomo",
//         profileImage: "./images/avatars/image-juliusomo.png",
//         createdAt: "",
//         // text = document.getElementsByClassName("textBox").value,
